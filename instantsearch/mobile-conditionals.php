<?php
/*
 * This snippet can be used to add some extra javascript variables to the global scope of the page, that you can
 * then use within the `instantsearch.php` template file to customize the javascript.
 *
...
/*
// reduce our per page to 3 if on mobile.
